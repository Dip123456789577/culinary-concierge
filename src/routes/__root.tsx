...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "An intimate London dining experience shaped by exceptional taste and timeless hospitality." },
      { name: "author", content: "Atelier Salon" },
      { property: "og:title", content: "Atelier Salon | London Dining" },
      { property: "og:description", content: "An intimate London dining experience shaped by exceptional taste and timeless hospitality." },
